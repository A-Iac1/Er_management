...
class AreaGestore:
    def __init__(self, root, username):
        ...
        # Carica la sezione "Gestione Pazienti" di default
        self.show_flussi()
    ...
    def show_flussi(self):
        ...
        frame_input_paziente = ctk.CTkFrame(frame_pazienti, fg_color="gray12")  # Colore scuro per la sezione input paziente
